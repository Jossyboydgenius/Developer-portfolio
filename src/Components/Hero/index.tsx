...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    const delayTimer = setTimeout(() => setStartTyping(true), 1200);
      ...
      <div className="wrapper info-container">
        <div className="column">
          ...
          <h1 className="heading-1 typing-container" data-aos="fade-down">
            <span className={getClassNames()} style={{ fontSize: 'var(--typing-font-size)' }}>
              {text}
            </span>
          ...
          <p className="muted" data-aos="fade-up" data-aos-delay="300">
            ...
            Leveraging cutting edge technologies to craft intuitive user experiences and robust
            backend systems. Let's build the future of tech together!
          </p>
        ...
        <div className="column hero-image" data-aos="fade-left" data-aos-delay="100">
          <Image src={me} alt="Awe Joseph" priority />
        </div>
      </div>
